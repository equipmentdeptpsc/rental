...
describe("operator Digital DEUR access", () => {
  it("allows the assigned Operator for Released or Active Rentals", () => {
    ...
    expect(evaluateOperatorDigitalDeurAccess({ actor, operator, assignment, rental: rental({ status: "Active" }), deurs: [], evaluationTimestamp: "2026-07-20T01:00:00.000Z", shift: "Day" }).allowed).toBe(true);
  });
  it.each([
