...
const rental: RentalRecord = { id: "rental-1", rentalNumber: "R-1", equipmentId: "", customerId: "customer-1", projectId: "project-1", customer: "Customer", project: "Project", rentedBy: "Admin", dateOut: "2026-07-20", statusId: "released", status: "Released", operationalMetadata: metadata };
const line = (id: string, equipmentId: string, operatorId: string, rate: number, billingMethod: "Per Hour" | "Per Day" = "Per Hour"): RentalEquipmentLine => ({ id, rentalId: rental.id, equipmentId, assignmentId: `assignment-${id}`, operatorId, status: "Released", operationalMetadata: metadata, commercialSnapshotRequired: true, commercialSnapshot: snapshot(rate, billingMethod), createdAt: "2026-07-20T00:00:00.000Z", updatedAt: "2026-07-20T00:00:00.000Z" });
