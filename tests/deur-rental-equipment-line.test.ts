...
const line = (id: string, equipmentId: string, operatorId: string, rate: number, billingMethod: "Per Hour" | "Per Day" = "Per Hour"): RentalEquipmentLine => ({ id, rentalId: rental.id, equipmentId, assignmentId: `assignment-${id}`, operatorId, status: "Active", operationalMetadata: metadata, commercialSnapshotRequired: true, commercialSnapshot: snapshot(rate, billingMethod), createdAt: "2026-07-20T00:00:00.000Z", updatedAt: "2026-07-20T00:00:00.000Z" });
