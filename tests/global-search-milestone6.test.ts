...
const data:GlobalSearchData={
 ...
 rentals:[{id:"r1",rentalNumber:"RNT-2026-0041",equipmentId:"e1",customerId:"c1",projectId:"p1",operatorId:"o1",assignmentId:"a1",customer:"Acme Builders",project:"Harbor Works",rentedBy:"Admin",dateOut:"2026-08-01",status:"Active",rentalType:"Operated Rental",billingMethod:"Per Day"}],
