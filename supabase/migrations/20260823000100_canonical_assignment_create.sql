...
VALUES('PERM-CANON-ASSIGNMENT-MANAGE','assignment.manage','Manage Assignments')
...
BEGIN
 ...
 BEGIN
  ...
  expected_on=coalesce(nullif(command->>'expectedReturn','')::date,assigned_on);
 EXCEPTION WHEN invalid_datetime_format OR datetime_field_overflow THEN
  RETURN jsonb_build_object('success',false,'code','VALIDATION_REJECTED');
 END;
 IF expected_on<assigned_on THEN RETURN jsonb_build_object('success',false,'code','VALIDATION_REJECTED');END IF;
