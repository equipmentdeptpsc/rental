...
-- The turnover inbox already establishes the authenticated caller and tenant.
-- Add only display labels for its existing, bounded custody identities; the IDs
-- remain authoritative for every command and authorization decision.
