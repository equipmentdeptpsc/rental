...
export function resolveOperatorDeurRouteLine(input: {
  ...
  if (!operator) return { status: "OPERATOR_NOT_FOUND", message: "The Rental equipment line's Operator record no longer exists. Review the Assignment before continuing." };
