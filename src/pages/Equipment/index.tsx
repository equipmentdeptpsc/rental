...
function CanonicalEquipmentPage() {
  ...
  const data = useCanonicalEquipmentData({ categoryId, subcategoryId, statusId, projectId });
  const options = useCanonicalEquipmentFilters(categoryId, canReadProjects);
