...
export default function ProjectPage() {
  ...
  return getProjectRuntimeCapability(configuration).canonicalReads ? <CanonicalProjectPage /> : <LocalProjectPage />;
}
