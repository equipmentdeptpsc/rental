  ...
  return (
    <div className="app-page">
      ...
      <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
        <EquipmentStatusChart data={model.statusData} />
