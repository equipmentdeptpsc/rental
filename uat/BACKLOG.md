...
| Billing Preview optional-term normalization | REMEDIATION READY | Remote DEUR projection omitted its referenced immutable snapshot and Contract optionals arrived as JSON null. Focused correction embeds the exact snapshot and omits only null optional values; expected read-only total is PHP 3,883.33. Deploy/certification remain; no financial mutation authorized. |
